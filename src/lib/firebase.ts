...
// Securely load from environment variables with graceful fallback to firebase-applet-config.json
...
// Initialize Firestore using secure custom database ID if available, fallback to firebase-applet-config.json database ID, then default
